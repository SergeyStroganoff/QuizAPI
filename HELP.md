...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.0.0-M1/reference/htmlsingle/#howto-execute-flyway-database-migrations-on-startup)
...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/3.0.0-M1/reference/htmlsingle/#configuration-metadata-annotation-processor)
